...
const initialCartItems = [
  { name: "Burger", price: 10.99, quantity: 2, image: "/pro.png" },
  { name: "Fresh Lime", price: 3.49, quantity: 1, image: "/mask.png" },
  { name: "Pizza", price: 9.99, quantity: 4, image: "/mas.png" },
  { name: "Chocolate Muffin", price: 4.49, quantity: 1, image: "/maske.png" },
  { name: "Cheese Butter", price: 11.99, quantity: 3, image: "/eg.png" },
];
...
const ShoppingCart: React.FC = () => {
  ...
  return (
    <div className="bg-white font-sans">
      <header className="bg-cover bg-center h-48 flex items-center justify-center" style={{ backgroundImage: '(/bg.png)' }}>
            ...
            {cartItems.map((item, index) => (
              <tr key={index} className="border-b">
                <td className="p-4 flex items-center">
                  <Image src={item.image} alt={item.name}  width={16}
              height={16} className="w-16 h-16 object-cover rounded mr-4" />
                  <span>{item.name}</span>
                </td>
