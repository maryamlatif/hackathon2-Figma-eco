  ...
  return (
    <section className="bg-black text-white py-16 relative overflow-hidden">
      <div className="container mx-auto px-12 text-center">
        <h2 className="text-amber-500 text-3xl italic mb-2">Testimonials</h2>
        ...
        <div className="bg-white text-black p-8 rounded-lg relative">
          <Image
            ...
            width={80}
            height={80}
            className="rounded-full border-4 border-white absolute -top-10 left-1/2 transform -translate-x-1/2"
          />
