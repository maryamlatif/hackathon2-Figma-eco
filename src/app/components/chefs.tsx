...
const chefs = [
  { name: 'D.Estwood', role: 'Chief Chef', image: '/one.png' },
  { name: 'D.Scoriesh', role: 'Assistant Chef', image: '/2.png' },
  { name: 'M. William', role: 'Advertising Chef', image: '/three.png' },
  { name: 'W.Readfroad', role: 'Chef', image: '/four.png' },
]
