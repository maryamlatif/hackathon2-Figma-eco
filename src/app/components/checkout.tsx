      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-between pt-4">
            ...
            <button className="px-6 py-2 bg-[#FF9F0D] text-white rounded-md shadow-sm text-sm font-medium hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 w-72 h-12">
            Proceed to shipping
            </button>
          </div>
        </div>
